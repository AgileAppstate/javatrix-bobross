...
#
# @author Dr. Fenwick
# @further Edits by Robert Scheffler 09/21/21
# @version Summer 2018
#
...
compile: HelloWorld.java $(CLI_JAR) HelloWorldTest.java $(JUNIT5_JAR) 
	javac -cp .:$(CLI_JAR) HelloWorld.java
	javac -cp .:$(JUNIT5_JAR) HelloWorldTest.java
...
defchk: HelloWorld.java $(CKSTYLE_XML)
